...
@Component
public class SelfSignedCertLoader {
    private static final String selfSignedCert = "self_signed_cert/test_cacert.crt";
    private static final String selfSignedPrivateKey = "self_signed_cert/test_private_key.pem";
