...
@Component
public class LocalhostStubAS2ClientRouteBuilder extends RouteBuilder {
                ...
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        ...
                        if (NEED_SIGNED_ENCRYPTED) {
                            ...
                            exchange.getIn().setHeader("CamelAS2.signingCertificateChain", selfSignedCertLoader.getChain());
    ...
    private void processMultipartMessage(Message message) {
        ...
        if (message.getBody() instanceof DispositionNotificationMultipartReportEntity) {
            ...
            try {
                ...
                ByteArrayDataSource datasource = new ByteArrayDataSource(bytess, "multipart/report");
