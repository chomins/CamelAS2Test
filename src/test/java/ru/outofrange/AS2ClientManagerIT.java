...
/**
 * Test class for {@link AS2ClientManager} APIs.
 */
public class AS2ClientManagerIT extends AbstractAS2ITSupport {
    ...
    private static final int MDN_TARGET_PORT = 8889;
    ...
    public void plainMessageSendTest() throws Exception {
        ...
        assertNotNull(String.valueOf(result), "send result");
        LOG.debug("send: " + result);
        assertNotNull(String.valueOf(request), "Request");
        assertTrue("Request does not contain body", request instanceof HttpEntityEnclosingRequest);
        HttpEntity entity = ((HttpEntityEnclosingRequest) request).getEntity();
        assertNotNull(String.valueOf(entity), "Request body");
        ...
        assertTrue("Unexpected response type",
                HttpMessageUtils.getHeaderValue(response, AS2Header.CONTENT_TYPE).startsWith(AS2MimeType.MULTIPART_REPORT));
        ...
        assertNotNull(String.valueOf(responseEntity), "Response entity");
        ...
        assertEquals(String.valueOf(2), reportEntity.getPartCount(), "Unexpected number of body parts in report");
        ...
        assertEquals("Unexpected value for disposition mode",
                DispositionMode.AUTOMATIC_ACTION_MDN_SENT_AUTOMATICALLY, messageDispositionNotificationEntity.getDispositionMode());
    ...
    public void plainMessageSend2Test() throws Exception {
        ...
        assertEquals(HttpMessageUtils.getHeaderValue(request, AS2Header.MESSAGE_ID),
                messageDispositionNotificationEntity.getOriginalMessageId(), "Unexpected value for original message ID");
        assertEquals(String.valueOf(DispositionMode.AUTOMATIC_ACTION_MDN_SENT_AUTOMATICALLY),
    ...
    public void envelopedMessageSendTest() throws Exception {
        ...
        HttpEntity entity = ((HttpEntityEnclosingRequest) request).getEntity();
        assertNotNull(String.valueOf(entity), "Request body");
        assertTrue("Request body does not contain ApplicationPkcs7Mime entity",
    ...
    public void multipartSignedMessageTest() throws Exception {
        ...
        assertNotNull(String.valueOf(signatureEntity), "Signature Entity");
    ...
    private void runAsyncMDNTest() throws CamelException, HttpException {
        ...
        try {
            ediEntity = EntityUtils.createEDIEntity(EDI_MESSAGE,
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct://SEND2").toF("as2://" + PATH_PREFIX + "/send?inBody=ediMessage&as2From=%s&as2To=%s", AS2_NAME,
                        AS2_NAME);
