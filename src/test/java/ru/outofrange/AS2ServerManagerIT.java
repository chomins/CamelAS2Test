...
/**
 * Test class for {@link AS2ServerManager} APIs.
 */
public class AS2ServerManagerIT extends AbstractAS2ITSupport {
    ...
    public void receivePlainEDIMessageTest() throws Exception {
        ...
        assertNotNull(String.valueOf(request.getFirstHeader(AS2Header.DATE)), "Date value missing");
        assertNotNull(String.valueOf(request.getFirstHeader(AS2Header.CONTENT_LENGTH)), "Content length value missing");
        ...
        assertNotNull(String.valueOf(entity), "Request does not contain entity");
    ...
    public void receiveMultipartSignedMessageTest() throws Exception {
        ...
        assertEquals(String.valueOf(2), signedEntity.getPartCount(), "Request contains invalid number of mime parts");
    ...
    public void sendEditMessageToFailingProcessorTest() throws Exception {
        ...
        assertEquals(String.valueOf(HttpStatus.SC_INTERNAL_SERVER_ERROR), response.getStatusLine().getStatusCode(),
